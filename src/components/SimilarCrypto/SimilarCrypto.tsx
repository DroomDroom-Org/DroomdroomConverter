...
// Format large numbers to M/B format
...
// // Temporary component definition for build
// const MetaInfo = ({ children }: { children: React.ReactNode }) => (
//     <div style={{
//         display: 'flex',
//         alignItems: 'center',
//         fontSize: '12px',
...
const SimilarCrypto = ({ coin }: { coin: any }) => {
    ...
    return (
        <Container>
            <Header>
                ...
                {/* <TimeFilters>
                    {timeOptions.map(option => (
                        <TimeButton
                            key={option}
                            active={activeTimeFilter === option}
                            onClick={() => setActiveTimeFilter(option)}
                        >
                            {option}
                        </TimeButton>
                    ))}
                    <SeeMoreButton onClick={() => fetchSimilarCoins()}>Refresh</SeeMoreButton>
                </TimeFilters> */}
            </Header>
                    ...
                    similarCoins.map((coinData, index) => (
                        ...
                        >
                            ...
                            <CoinInfo>
                                ...
                                {/* <MetaInfo>
                                    {getMetaIcon(coinData.meta.type)}
                                    {coinData.meta.value}
                                </MetaInfo> */}
                            </CoinInfo>
                        </CoinCard>
            ...
            {Object.keys(ecosystemCoins).length > 0 && 
