...
export const MarketStatsRow = styled.div`
  ...
  &:nth-child(even) {
    background: ${props => props.theme.name === 'dark' ? 'rgba(255, 255, 255, 0.03)' : 'rgba(0, 0, 0, 0.02)'};
  }
`;
...
export const MarketStatsValue = styled.div<{ $positive?: boolean, $negative?: boolean }>`
  font-size: 14px;
  font-weight: 600;
  color: ${props => 
